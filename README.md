...
├── README.md                         # This file
├── USER_GUIDE.md                     # USER Guide to just visulaize the result on react app
├── INSTALL.md                        # Full Install Guide to install all dependency
├── RUNNING.md                        # Running guide to run Anuga Simulation
